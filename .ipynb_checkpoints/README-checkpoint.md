...
- en complément, si vous avez installé `juduino`, le document [./dev/pressions_mesures.ipynb](./dev/pressions_mesures.ipynb) est un bon exemple de mesures point par point avec Jupyter.
